...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(
                ...
                //getClass().getResource("/com/oop4clinic/clinicmanagement/fxml/MedicalRecordManagement.fxml")
                // getClass().getResource("/com/oop4clinic/clinicmanagement/fxml/TEST.fxml")
        );
